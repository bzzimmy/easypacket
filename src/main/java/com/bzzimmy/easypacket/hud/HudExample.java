package com.bzzimmy.easypacket.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(EasyPacket.HUD_GROUP, "example", "HUD element example.", HudExample::new);
