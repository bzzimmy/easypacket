package com.bzzimmy.easypacket.modules;
...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(EasyPacket.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link EasyPacket#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
